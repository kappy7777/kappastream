...
| **DecAPI** | Retrieve live status, viewer count, title, and game |

These third-party services can see the normal information associated with a network request, such as your IP address. kappastream does not send them a Twitch account, OAuth token, client ID, personal profile, or kappastream identifier.
